    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Curso <span class="text-5-title">* Campo Obrigatório</span></h3>
...
unset($__errorArgs, $__bag); ?>" id="edtCourse" name="course" placeholder="Informe o curso" required autocomplete="course" autofocus/>
...
unset($__errorArgs, $__bag); ?>                                     
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea class="form-control" id="edtAdditional_information" name="additional_information"><?php echo e(Session::get('additional_information')); ?></textarea>
                    </div>
                </div>
...
<script>
    $('#updateCourse').click(function(event) {
        var form = $('#updateForm') 
         $.ajax({
            url: "<?php echo e(route('updateCourse')); ?>",
            type: 'POST',
            data:form.serialize(),
...
</script><?php /**PATH C:\censupeg\resources\views/course/edit_modal_course.blade.php ENDPATH**/ ?>