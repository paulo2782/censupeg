                ...
                <input type="hidden" name="id" id="id_edt_modal">
                 <div class="form-row">
                    <div class="form-group col-12">
                        ...
                        <input type="password" class="form-control" id="password" name="old_password" placeholder="Informe a senha atual" required autofocus/>
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="Informe a nova senha" required autofocus/>
                        <span toggle="#password" class="fa fa-fw fa-eye field_icon toggle-password"></span>
                    </div>
                    <div class="form-group col-12">
                        <label class="text-4" for="confirm-password">Repetir nova senha</label>
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Repetir nova senha" required autofocus/>
                        <span toggle="#password" class="fa fa-fw fa-eye field_icon toggle-password"></span>
                    </div>
                </div>
