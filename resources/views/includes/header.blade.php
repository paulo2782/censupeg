...
<div id="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="{{ route('dashboardShow',date('Y-m-d')) }}"><img src="{{ asset('img/logo-censupeg-header.png') }}" alt="Logo da Censupeg" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboardShow',date('Y-m-d')) }}">Dashboard</a>
                    </li>
