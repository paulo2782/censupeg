...
<!-- <script src="{{ asset('js/validate/dist/bootstrap-validate.js') }}"></script> -->
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="callback"></div>
            <!-- Modal body -->
            <form class="form-dialog registerForm" id="contact-modal">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="administracao" value="Administração" >
                    <label class="form-check-label" for="administracao">Administração</label>
                    <input class="form-check-input" type="checkbox" id="analise_desenvolvimento_sistema" value="Análise e Desenvolvimento de Sistema">
                    <label class="form-check-label" for="analise_desenvolvimento_sistema">Análise e Desenvolvimento de Sistema</label>
                    <input class="form-check-input" type="checkbox" id="ciencias_contabeis" value="Ciências Contábeis">
                    <label class="form-check-label" for="ciencias_contabeis">Ciências Contábeis</label>
                    <input class="form-check-input" type="checkbox" id="educacao_especial" value="Educação Especial">
                    <label class="form-check-label" for="educacao_especial">Educação Especial</label>
                    <input class="form-check-input" type="checkbox" id="gestao_ambiental" value="Gestão Ambiental">
                    <label class="form-check-label" for="gestao_ambiental">Gestão Ambiental</label>
                    <input class="form-check-input" type="checkbox" id="gestao_financeira" value="Gestão Financeira">
                    <label class="form-check-label" for="gestao_financeira">Gestão Financeira</label>
                    <input class="form-check-input" type="checkbox" id="historia" value="História">
                    <label class="form-check-label" for="historia">História</label>
                    <input class="form-check-input" type="checkbox" id="letras" value="Letras - Língua Portuguesa">
                    <label class="form-check-label" for="letras">Letras - Língua Portuguesa</label>
                    <input class="form-check-input" type="checkbox" id="logistica" value="Logística">
                    <label class="form-check-label" for="logistica">Logística</label>
                    <input class="form-check-input" type="checkbox" id="matematica" value="Matemática">
                    <label class="form-check-label" for="matematica">Matemática</label>
                    <input class="form-check-input" type="checkbox" id="pedagogia" value="Pedagogia">
                    <label class="form-check-label" for="pedagogia">Pedagogia</label>
                    <input class="form-check-input" type="checkbox" id="processos_gerenciais" value="Processos Gerenciais">
                    <label class="form-check-label" for="processos_gerenciais">Processos Gerenciais</label>
                    <input class="form-check-input" type="checkbox" id="recursos_humanos" value="Recursos Humanos">
                    <label class="form-check-label" for="recursos_humanos">Recursos Humanos</label>
                    <input class="form-check-input" type="checkbox" id="saude" value="Saúde">
                    <label class="form-check-label" for="saude">Saúde</label>
                    <br />
                    <input class="form-check-input" type="checkbox" id="educacao-ead" value="Educação - EAD">
                    <label class="form-check-label" for="educacao-ead">Educação - EAD</label>
                    <input class="form-check-input" type="checkbox" id="gestao-negocios-ead" value="Gestão de negócios - EAD">
                    <label class="form-check-label" for="gestao-negocios-ead">Gestão de negócios - EAD</label>
                    <br />
                    <input class="form-check-input" type="checkbox" id="aba" value="ABA - PÓS Presencial">
                    <label class="form-check-label" for="aba">ABA - PÓS Presencial</label>
                    <input class="form-check-input" type="checkbox" id="arteterapia" value="Arteterapia - PÓS Presencial">
                    <label class="form-check-label" for="arteterapia">Arteterapia - PÓS Presencial</label>
                    <input class="form-check-input" type="checkbox" id="duo-neuropsicopedagogia" value="Duo Neuropsicopedagogia - PÓS Presencial">
                    <label class="form-check-label" for="duo-neuropsicopedagogia">Duo Neuropsicopedagogia - PÓS Presencial</label>
                    <input class="form-check-input" type="checkbox" id="mba" value="MBA - PÓS Presencial">
                    <label class="form-check-label" for="mba">MBA - PÓS Presencial</label>
                    <input class="form-check-input" type="checkbox" id="musicoterapia" value="Musicoterapia - PÓS Presencial">
                    <label class="form-check-label" for="musicoterapia">Musicoterapia - PÓS Presencial</label>
                    <input class="form-check-input" type="checkbox" id="saude-pos" value="Saúde - PÓS Presencial">
                    ...
                    <input type="text" class="form-control" id="outro-curso" style="display:none"  />
                </div>
                </div>
                ...
                <div class="form-group col-auto">
                    ...
                    <input type="date" class="form-control" id="date_contact" name="date_contact" />
                </div>
                <div class="form-group col-auto">
                    <label class="label-name" for="contact-date">Retorno agendado</label>
                    <input type="date" class="form-control" id="scheduled_return" name="scheduled_return" />
                </div>
                <div class="form-group col-auto">
                ...
                <div class="line-horizontal"></div>
                <button type="button" id="add" class="btn-form"    data-dismiss=" ">Salvar</button>
