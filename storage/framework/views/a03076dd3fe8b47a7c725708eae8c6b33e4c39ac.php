				...
				<form id="contact-info" method="#">
					<div class="form-row">
						...
						<div class="form-group col-12">
							...
							<input type="text" class="form-control" id="nameContact" name="name" value="<?php echo e($dados[0]->name); ?>" />
						</div>
						<div class="form-group col-12">
							<label class="text-4" for="emailContact">Email</label>
							<input type="email" class="form-control" id="emailContact" name="email" value="<?php echo e($dados[0]->email); ?>" />
						</div>						
						<div class="form-group col-12">
