...
<div class="modal fade" id="myModalSchedule">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="callback"></div>
            <form class="form-dialog registerForm" id="contact-modal" action="<?php echo e(route('storeCall')); ?>" method="post">
                <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
                <input type="hidden" id="token" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="hidden" name="contact_id" value="<?php echo e($dados[0]->id); ?>" id="contact_id">
...
$.get("<?php echo e(route('searchInterestModal')); ?>", {contact_id:contact_id}, function(data) { 
    var iCount = data.dados.length
    for(i = 0 ; i <= iCount-1 ; i++){
        $('#id').append("<option value="+data.dados[i].id+">"+data.dados[i].course)
    }
})
</script><?php /**PATH C:\censupeg\resources\views/contact/modal_contact_schedule.blade.php ENDPATH**/ ?>