<div class="modal fade" id="myModalAdd">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="callback"></div>
            <form name="add_partner" class="form-dialog registerForm" action="<?php echo e(route('storePartner')); ?>" method="POST">
...
<script src="<?php echo e(asset('js/partners.js')); ?>"></script><?php /**PATH C:\censupeg\resources\views/partners-business/add_modal_partner.blade.php ENDPATH**/ ?>