...
class MailingController extends Controller
{
    ...
    public function mailingAjax(Request $request)
    {
        ...
        $dataDayMonth     = DB::table('calls')
            ...
            ->select('calls.id as call_id', 'calls.contact_id as contact_id', 'calls.date_contact as date_contact',
                'calls.date_return as date_return', 'calls.schedule as schedule', 'calls.status as status',
                'calls.additional_information as additional_information', 'calls.user_id as user_id',
                'calls.course_id as course_id', 'calls.created_at as created_at', 'calls.time as time',
                'courses.course as course', 'users.deleted_at',
                'contacts.name as name')
            ->where('date_contact', 'like', '%' . $request->get('iMonth') . '%')
