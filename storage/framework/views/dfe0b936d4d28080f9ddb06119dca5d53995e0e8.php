...
<head>
    ...
    <title>Recuperação de senha - Censupeg Criciúma</title>
    ...
    <style>
		...
		* { -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; }
		...
		table { border-spacing: 0 !important; border-collapse: collapse !important; table-layout: fixed !important; margin: 20px auto !important; }
		...
		.primary { background: #9e1d21; }
		.bg_white { background: #ffffff; }
		.bg_light { background: #fafafa; }
		.email-section { padding: 2.5em; }
		/*BUTTON*/
		.btn { padding: 10px 15px; display: inline-block; }
		.btn.btn-primary { border-radius: 5px; background: #9e1d21; color: #ffffff; }
		.btn.btn-primary:hover { background: #fff; color: #9e1d21; border: 1px solid #9e1d21; font-weight: bold;}
		h1, h2, h3 { font-family: 'Lato', sans-serif; color: #000000; margin-top: 0; font-weight: 400; }
		body { font-family: 'Lato', sans-serif; font-weight: 400; font-size: 15px; line-height: 1.8; color: rgba(0, 0, 0, 0.4); }
		/*LOGO*/
		.logo h1 { margin: 0; }
		.logo h1 a { color: #9e1d21; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif; }
		/*FOOTER*/
		.footer { border-top: 1px solid rgba(0, 0, 0, 0.05); color: rgba(0, 0, 0, 0.5); }
				...
				<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="logo" style="text-align: center;">
							<h1><a href="#">Recuperação de senha</a></h1>
						</td>
					</tr>
				</table>
			</td>
						...
						<tr>
							<td>
								<div class="text" style="padding: 0 2.5em; text-align: center;">
									...
									<p><a href="http://censupeg.decarlosolucoes.tech/crm/alter_new_password/<?php echo e($token); ?>" class="btn btn-primary">Criar nova senha</a></p>
								</div>
							</td>
						</tr>
					</table>
...
</html><?php /**PATH C:\censupeg\resources\views/auth/send.blade.php ENDPATH**/ ?>